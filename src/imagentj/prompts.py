...
- capture_ui_window(target="auto"): Screenshots what the user has on screen and returns a
  ...
  Do NOT expect the main ImageJ/Fiji window, image windows, Log, or Results — the Fiji scan
  deliberately skips those and reports only plugin parameter dialogs.
