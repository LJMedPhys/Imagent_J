...
supervisor_prompt = """
                     ...
                     - IMPORTANT: ALWAYS save the scripts generated by subagents into the "scripts" subfolder of this project directory. This ensures all related files are organized together and can be easily accessed for debugging and future reference.
