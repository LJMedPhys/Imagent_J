...
| **OpenRouter** | `OPEN_ROUTER_API_KEY` | Proxy that routes to many providers. Required for the VLM Judge (`google/gemini-3.5-flash`); without it, visual judging is skipped safely. |
