...
| `WORKFLOW_FINETUNE_2_ANNOTATE.py` | Stage 2: the annotator with an ADD/DRAW/PAINT/DELETE helper panel docked in; blocks until the user closes it, then prints a per-tile status table. Resumes an interrupted session |
